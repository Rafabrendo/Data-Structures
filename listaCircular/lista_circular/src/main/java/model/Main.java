...
public class Main {
    ...
    public static void main(String[] args){
        ...
        System.out.println(minhaListaCircular.get(3)); //Vai voltar pro inicio, demonstrando o loop
        System.out.println(minhaListaCircular.get(4));//Nesse caso, vai pro segundo elemento
